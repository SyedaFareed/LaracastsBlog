    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative lg:inline-flex bg-gray-100 rounded-xl">
            ...
            <div x-data="{ show: false }" @click.away="show=false">
                <button @click="show = ! show"
                    ...
                    {{--if a category is being selected show it, otherwise show categories --}} 
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 mt-2 rounded-xl w-full z-50" style="display: none">
                    <a href="/"
                        ...
                        All
                    </a> {{-- ucwords is for capitalization of first character of each word --}}
                    ...
                    @foreach ($categories as $category)
                        <a href="/categories/{{ $category->slug }}"
                            ...
                            >{{ ucwords($category->name) }} {{--if we are viewing a specific category page, change bg in dropdown--}}
                        </a> {{-- ucwords is for capitalization of first character of each word --}}
                    @endforeach
                </div>
            </div>
        ...
        <div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl px-3 py-2">
            <form method="GET" action="#">
                ...
                <!-- Let the searched word stay in search box -->
            </form>
        </div>
    </div>
</header>
